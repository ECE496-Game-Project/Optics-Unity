...
//            var waveSource = transform.GetChild(0)?.GetComponent<Wave>();
...
//                SetDevicePositions();
//                m_uiManager.SetActive(false);
//                WaitForOneFixedUpdateAndTrigger((I_ParameterPanel)gameObject.transform.GetChild(0).GetComponent<Wave>(), () => { m_uiManager.SetActive(true); });
