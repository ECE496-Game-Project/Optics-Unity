...
export type TouchScreenKeyboardType = 'default' | 'ascii-capable' | 'numbers-and-punctuation' | 'url' | 'number-pad' | 'phone-pad' | 'name-phone-pad' | 'email-address' | 'nintendo-network-account' | 'social' | 'search ' | 'decimal-pad ';
export type ContentType = 'standard' | 'autocorrected' | 'integer-number' | 'decimal-number' | 'alphanumeric' | 'name' | 'email-address' | 'password' | 'pin' | 'custom';
export type CharacterValidation = 'none' | 'digit' | 'integer' | 'decimal' | 'alphanumeric' | 'name' | 'regex' | 'email-address' | 'custom-validator';
