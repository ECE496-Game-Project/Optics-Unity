...
export interface UGUIElements extends BaseElements<BaseCmp> {
    view: Components.View & RefAttributes<NS.ContainerComponent> & {
        tag?: string;
    } & Children;
...
export declare namespace JSX {
    ...
    interface IntrinsicAttributes extends React.JSX.IntrinsicAttributes, ReactUnityCustomAttributes {
    }
